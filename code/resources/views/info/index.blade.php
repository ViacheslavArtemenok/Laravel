...
<div class="offset-2 col-8">
    ...
    <form method="post" action="#">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="userComment" id="userComment" value="{!! old('userComment') !!}"></textarea>
        </div><br>
...
<div class="offset-2 col-8">
    ...
    <form method="post" action="#">
        ...
        <div class="form-group">
            ...
            <input type="tel" class="form-control" name="userPhone" id="userPhone" value="{{ old('userPhone') }}">
        </div>
        <div class="form-group">
            <label for="userEmail">Email</label>
            <input type="email" class="form-control" name="userEmail" id="userEmail" value="{{ old('userEmail') }}">
        </div>
        <div class="form-group">
            <label for="userInfo">Текст запроса</label>
            <textarea class="form-control" name="userInfo" id="userInfo" value="{!! old('userInfo') !!}"></textarea>
        </div><br>
        <button class="btn btn-primary" type="submit">Сохранить</button>
    </form>
</div>
